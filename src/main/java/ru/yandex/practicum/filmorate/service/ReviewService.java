...
import ru.yandex.practicum.filmorate.storage.review.dislikes.ReviewDislikesStorage;
...
public class ReviewService {
    ...
    public void addDislike(Integer reviewId, Integer userId) {
        Validation.validateReviewId(reviewStorage, reviewId);
        Validation.validateUserId(userStorage, userId);
        reviewDislikesStorage.addDislike(reviewId, userId);
    }

    public void deleteDislike(Integer reviewId, Integer userId) {
        Validation.validateReviewId(reviewStorage, reviewId);
        Validation.validateUserId(userStorage, userId);
        reviewDislikesStorage.deleteDislike(reviewId, userId);
    }
}
